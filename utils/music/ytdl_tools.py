    ...
    async def get_track_info(self, url: str, user: disnake.Member = None, loop = None):
        ...
        for e in self.extractors:
            ...
            if e["age_limit"] > 17 and e["ie_key"] != "Twitter":
                raise GenericError("**Bu bağlantı 18 yaşından büyükler için içerik içermektedir!**")
            ...
            try:
                if data["_type"] == "playlist":
                    raise GenericError("**Şu anda sağlanan bağlantı ile çalma listeleri için destek yok...**")
            except KeyError:
                pass
